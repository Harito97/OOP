package patterns.command.pseudocode;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        app.activeEditor.replaceSelection("Harito");
        System.out.println("selection của editor0 sau khi chọn \"Harito\": " + app.activeEditor.getSelection());
